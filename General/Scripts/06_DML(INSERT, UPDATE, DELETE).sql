--- DQL(Data Qyery Kabgyage) : 데이터 질의 언어(SELECT)
--> DQL은 DML에 포함된 형태
...
-- INSERT + 서브쿼리를 이용해 여러 행 INSERT하기
INSERT INTO EMP_01(
SELECT
...
DELETE FROM EMPLOYEE2 WHERE EMP_NAME = '장채현'; -- 1행 삭제
-- 삭제 확인
SELECT * FROM EMPLOYEE2 WHERE EMP_NAME = '장채현';
-- EMPLOYEE2 테이블 전체 삭제
