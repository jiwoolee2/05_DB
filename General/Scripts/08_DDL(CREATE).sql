...
--> FORIGN KEY가 설정된 컬럼의 값은 
-- 외부(다른 테이블)의 값을 사용할 수 있다(== 다른 테이블에서 사용할 수 있다(참조))
...
CREATE TABLE USER_GRADE(
  GRADE_CODE NUMBER PRIMARY KEY,  -- FOREIGN KEY 제약조건으로 참조할 수 있는 대상
...
--> ORA-02290: 체크 제약조건(KH18_LJW.CHECK_SCORE)이 위배되었습니다
...
DROP TABLE USER_TEST; -- 잘못만들었을 때 한 번씩 실행
...
VALUES(1,'LL','1Q2W3E4R','001009-','남',01052292929,'인천','Y');
INSERT INTO "USER_TEST"
VALUES(2,'L','1Q2WE4R','0010021','남',01052292929,'서울','Y');
INSERT INTO "USER_TEST"
VALUES(1,'LL','1Q2W3E4R','001009-','남',01052292929,'광주','Y');
INSERT INTO "USER_TEST"
VALUES(1,'LL','1Q2W3E4R','001009-','남',01011269859,'대전','Y');
INSERT INTO "USER_TEST"
VALUES(1,'LL','1Q2W3E4R','001009-','남',01052292339,'파주','Y');
...
/* PRIMARY KET, FOREIGN KEY, UNIQUE, CHECK 제약조건은
 * 컬럼을 제약하는 별도의 객체를 추가(ADD)하는 모습
 * 
 * NOT NULL은 
 * 컬럼의 상태(NULL 허용, NULL 불가)를 수정하는 모습
 * -> MODIFY
 * 
 */
