...
CREATE USER TEST18_USER IDENTIFIED BY"TEST1234";
...
GRANT CREATE SESSION TO TEST18_USER;
--> 연결 확인됨

/* 생성된 사용자 계정으로 접속(TEST18_USER) */
...
/* TEST18_USER에게 TABLE 생성 공간 할당 */
ALTER USER TEST18_USER
DEFAULT TABLESPACE USERS
QUOTA 10M ON USERS;


/* 다시 사용자 계정으로 접속(TEST18_USER) */
CREATE TABLE TEST_TABLE(
	TEST_NO NUMBER PRIMARY KEY,
	TEST_COL VARCHAR2(30) NOT NULL
); --> 생성 성공
...
/* 객체 권한 부여 */
SELECT * FROM KH18_LJW.EMPLOYEE; --> 없어서 조회X
